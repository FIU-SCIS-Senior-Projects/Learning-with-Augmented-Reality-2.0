...
public class Heat : MonoBehaviour {
    ...
    public float duration = 1.5f; // duration in seconds
    public float t = 0; // lerp control variable

    public GameObject testname;


    public ClickAction myClick;
    /// <summary>
    /// Constructor
    /// </summary>
    void Start()
    {
        ...
        obj1.GetComponent<MeshRenderer>().enabled = true; //was set to false for the UI to start it using obj2
    ...
    void InitGrid()
    {
        ...
        M1[Random.Range(1, 0), Random.Range(1, 0), Random.Range(1, 0)].GetComponent<MeshRenderer>().material.color = Color.red;
        M1[Random.Range(1, 1), Random.Range(1, 1), Random.Range(1, 1)].GetComponent<MeshRenderer>().material.color = Color.red;
        //hides the initial sphere
        obj.GetComponent<MeshRenderer>().enabled = false;
        //For camera stuff, thus ignore
                        ...
                        for (int l = -1; l < 2; l++) 
                            for (int k = -1; k < 2; k++)
                                for (int j = -1; j < 2; j++)
                                    ...
                                    else if (M1[x + j, y + k, z + l].GetComponent<MeshRenderer>().material.color == r) n++;
                                    //else if (M2[x + j, y + k, z + l] == true) n++;
                    ...
                    for (int x = 0; x < gridS; x++)
                    {
                        ...
                        if (M2[x, y, z] == true)
                        {
                            ...
                            //{
                                ...
                                M1[x, z, y].GetComponent<MeshRenderer>().material.color = r;
                            //}
                        ...
                        {
                            M1[x, z, y].GetComponent<MeshRenderer>().material.color = b;
                        }
                    }
            }
            //t++;
    ...
    {
        while (Color.Lerp(Color.blue, Color.red, .5f * Time.deltaTime) < )
            {
    ...
    */
    ...
    /*
    public void gradualColorChange()
    {
    ...
    */
    ...
    void OnGUI()
    {
        ...
        if (GUI.Button(new Rect(10, 405, 120, 20), "New"))
        {
            ...
            for (int z = 0; z < gridS; z++)
                for (int y = 0; y < gridS; y++)
                    for (int x = 0; x < gridS; x++) Destroy(M1[x, y, z]);
            gridS = gS;
    ...
    void ColorChanger(GameObject sphere)
    {
        //iSphere = sphere;

        sphere.GetComponent<Renderer>().material.color = Color.Lerp(Color.red, Color.blue, t);
